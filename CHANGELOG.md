...
- Tracker-backed work-unit scope validation now rejects non-exact numeric or
  conventional-prefix aliases and compares duplicate roots by full ticket
  identity instead of ticket number alone.
