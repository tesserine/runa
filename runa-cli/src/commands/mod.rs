...
pub enum CommandError {
    ...
    WorkUnitIdentity(libagent::WorkUnitIdentityError),
}
...
impl fmt::Display for CommandError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            CommandError::WorkUnitIdentity(err) => write!(f, "{err}"),
        }
    }
}
...
impl std::error::Error for CommandError {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            CommandError::WorkUnitIdentity(err) => Some(err),
        }
    }
}
...
impl From<libagent::WorkUnitIdentityError> for CommandError {
    fn from(err: libagent::WorkUnitIdentityError) -> Self {
        CommandError::WorkUnitIdentity(err)
    }
}
...
pub fn validate_work_unit_scope(
